    ...
    <>
      ...
      <section id="introdution" className="text-justify">
        <Typography className="py-2 text-sm md:text-lg">
          ...
          và tiện ích giải trí đẳng cấp. Được đầu tư và phát triển bởi Gamuda
          Land – Tập đoàn bất động sản số 1 Malaysia. Lấy cảm hứng từ nhịp điệu
          chuyển động của những con sóng và ngôn ngữ điêu khắc của sự hình thành
        ...
        <Typography className="text-sm md:text-lg">
          ...
          nơi an cư lý tưởng, tại Eaton Park quý cư dân sẽ cảm nhận được giá trị
          sống đẳng cấp, không gian xanh được đưa vào dự án sẽ mang lại sự thư
          thái cho tâm hồn. Nơi đây tràn ngập hy vọng và niềm tin về cuộc sống
          hạnh phúc yên bình, Eaton Park sẽ là nơi chào quý cư dân và những
          người thân yêu đến chốn bình yên nơi phong cách nghỉ dưỡng hòa quyện
          cùng loạt tiện ích đa dạng tại thành phố Thủ Đức.
        </Typography>
      </section>
