    ...
    <>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 my-5">
        <Typography className="text-sm md:text-lg">
          ...
          công trên nhiều lĩnh vực kinh doanh đã quyết định thành lập Công ty CP
          đầu tư và phát triển đô thị Việt Hưng (Vihajico). Sự ra đời của công
          ty gắn liền với sứ mệnh xây dựng một khu đô thị sinh thái chức năng
          đầu tiên ở Việt Nam theo xu hướng phát triển đô thị hiện đại của các
          quốc gia trên thế giới: khu đô thị Ecopark. Qua hơn hai thập kỷ phát
          triển và hoàn thiện, Ecopark đã trở thành một thành phố chức năng kiểu
          mẫu, tiên phong xác lập xu hướng Bất động sản Xanh với giá cả hợp lý,
          được quốc tế tôn vinh với nhiều giải thưởng danh giá. Ban lãnh đạo
          công ty đã quyết định thay đổi tên thành Công ty CP Tập đoàn Ecopark,
          hướng tới mục tiêu phát triển bền vững, đầu tư đa ngành vào các lĩnh
          vực như giáo dục, y tế, nông nghiệp sạch, công nghệ cao, du lịch, vui
          chơi giải trí…; đồng thời vẫn giữ vững vị thế chủ chốt là Tập đoàn đầu
          tư và phát triển đô thị chuyên nghiệp theo xu hướng Bất động sản Xanh,
          mở rộng phát triển mô hình đô thị Ecopark trên địa bàn cả nước.
        </Typography>
