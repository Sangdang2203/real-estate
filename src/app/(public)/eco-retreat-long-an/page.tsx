        ...
        <div className="mb-14">
          ...
          <section id="introdution" className="text-justify">
            <Typography className="text-[14px] md:text-[16px]">
              ...
              sạch, công nghệ cao, du lịch và vui chơi giải trí. Đồng thời
              Ecopark cũng giữ vững vị thế chủ chốt là một tập đoàn đầu tư và
              phát triển đô thị chuyên nghiệp, theo xu hướng Bất động sản Xanh,
              mở rộng và phát triển mô hình đô thị Ecopark trên khắp cả nước.
            </Typography>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-5">
              ...
              <Typography className="text-[14px] md:text-[16px]">
                ...
                Sự ra đời của công ty gắn liền với sứ mệnh xây dựng một khu đô
                thị sinh thái chức năng đầu tiên ở Việt Nam theo xu hướng phát
                triển đô thị hiện đại của các quốc gia trên thế giới: khu đô thị
                Ecopark. Qua hơn hai thập kỷ phát triển và hoàn thiện, Ecopark
                đã trở thành một thành phố chức năng kiểu mẫu, tiên phong xác
                lập xu hướng Bất động sản Xanh với giá cả hợp lý, được quốc tế
                tôn vinh với nhiều giải thưởng danh giá. Ban lãnh đạo công ty đã
                quyết định thay đổi tên thành Công ty CP Tập đoàn Ecopark, hướng
                tới mục tiêu phát triển bền vững, đầu tư đa ngành vào các lĩnh
                vực như giáo dục, y tế, nông nghiệp sạch, công nghệ cao, du
                lịch, vui chơi giải trí…; đồng thời vẫn giữ vững vị thế chủ chốt
                là Tập đoàn đầu tư và phát triển đô thị chuyên nghiệp theo xu
                hướng Bất động sản Xanh, mở rộng phát triển mô hình đô thị
            ...
            <div>
              <Typography className="text-[14px] md:text-[16px]">
                ...
                . Dự án không chỉ mở ra cánh cửa hưởng thụ cuộc sống thượng lưu,
                mà còn là bức tranh tươi mới về một Long An đáng sống và đẳng
                cấp.
              </Typography>
            ...
            <div className="flex-col justify-between">
              <div id="grad" className="p-4 rounded-t-lg opacity-95">
                ...
                <Typography className="text-white text-justify  leading-loose text-[12px] md:text-[16px]">
                  ...
                  trú ẩn lý tưởng cho những gia chủ kiếm tìm sự bình yên nơi
                  thiên nhiên bên cạnh sự tiện lợi và phồn vinh nơi phố thị Eco
                  Retreat lại càng đắc địa khi thuộc về Bến Lức – một trong
                  những khu đô thị vệ tinh lớn nhất của Tp.HCM với cơ sở hạ tầng
                  giao thông đồng bộ, thuận tiện. Từ đây, cư dân Eco Retreat có
                  thể dễ dàng kết nối với mọi nơi và trải nghiệm cuộc sống đa
                  sắc màu.
                </Typography>
              </div>
              <Image
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                <Typography className="text-[14px] md:text-[16px]">
                  ...
                  resort, cùng trải nghiệm tận hưởng sự tiện nghi và dịch vụ
                  chất lượng bậc nhất. Bố trí các tiện ích hoà cùng mảng sống
